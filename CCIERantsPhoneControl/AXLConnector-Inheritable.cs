...
namespace ccierants.baseclasses
{
    class AXLConnector
    {
        protected string cucmip;
        protected string cucmusername;
        protected string cucmpassword;
        protected string cucmhttppath;

        protected string cucmheaders; // some stuff wants different headers, beats me
        protected string cucmcontenttype; // content type sometimes needs to be set.
        ...
        public virtual string getSoapHeader()
        {
      ...
      <ns:addSrst sequence="?">
        ...
        private void sendAXLCommand(string soapreq)
        {
            ...
            try
            {
                ...
                System.Net.HttpWebRequest req = (System.Net.HttpWebRequest)WebRequest.Create("https://" + cucmip + cucmhttppath);
        ...
        protected XDocument  sendAXLCommandReturnXML(string soapreq)
        {
            ...
            try
            {
                ...
                System.Net.HttpWebRequest req = (System.Net.HttpWebRequest)WebRequest.Create("https://" + cucmip + cucmhttppath);
                req.ProtocolVersion = System.Net.HttpVersion.Version10;
                req.ContentType = cucmcontenttype;
                req.Method = "POST";
                req.Headers.Add(cucmheaders);
                ...
                using (System.Net.WebResponse webresp = (System.Net.WebResponse)req.GetResponse())
                {
                    ...
                    StreamReader XMLStreamReader = new StreamReader(returnedData);

                    XNamespace ns = "http://schemas.cisco.com/ast/soap";
                    

                   document =  XDocument.Parse(XMLStreamReader.ReadToEnd());
...
//            this.sendAXLCommand(soapreq);
 ...
 <routePattern>
        ...
        protected virtual string getSoapFooter()
        {
            // This returns the standard SOAP header 
