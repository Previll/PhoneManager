...
namespace LumiSoft.Net.IO
{
    ...
    {   
        ...
        private int      m_StoredInBuffer = 0;
        ...
        public string ReadLine()
        {
            ...
            int storedCount = ReadLine(m_pLineBuffer,0,m_pLineBuffer.Length,SizeExceededAction.ThrowException);
            if(storedCount == -1){
                return null;
            }
            else{
        ...
        public virtual void SyncStream()
        {
            ...
            if(this.AvailableInBuffer > 0){
                m_pSource.Position -= this.AvailableInBuffer;
                m_OffsetInBuffer = 0;
                m_StoredInBuffer = 0;
            }
        }
